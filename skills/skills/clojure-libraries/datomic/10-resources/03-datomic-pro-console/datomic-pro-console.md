...
<a id="outline-container-starting-the-console"></a>

<a id="starting-the-console"></a>

## Starting the Console

<a id="text-starting-the-console"></a>
...
<a id="outline-container-specifying-database"></a>

<a id="specifying-database"></a>

## Specifying a Database

<a id="text-specifying-database"></a>
...
<a id="outline-container-exploring-schema"></a>

<a id="exploring-schema"></a>

## Exploring Schema

<a id="text-exploring-schema"></a>
...
<a id="outline-container-exploring-data"></a>

<a id="exploring-data"></a>

## Exploring Data

<a id="text-exploring-data"></a>
...
- Use the *where* table to specify one or more *:where* clauses. You

only need to specify as many values as the clause requires, starting on the left.
...
Transaction data is presented at Day, Hour, Minute, and Second scale. At Day, Hour and Minute scale, the bars on the graph represent the number of transactions processed. On the Second scale, the bars on the number of datoms processed.
...
<a id="outline-container-data-sources"></a>

<a id="data-sources"></a>

## Data Sources

<a id="text-data-sources"></a>
