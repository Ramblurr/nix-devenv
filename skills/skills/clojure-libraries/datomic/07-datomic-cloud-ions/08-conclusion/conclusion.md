...
<a id="ions-cleanup-tutorial"></a>

# Ions Cleanup Tutorial

<a id="outline-container-ion-cleanup"></a>

<a id="ion-cleanup"></a>

## Cleanup

<a id="text-ion-cleanup"></a>

If you want to [delete your Datomic Cloud system](../../05-operation/02-cloud/15-deleting/deleting.md) after you've deployed an Ion, first deploy an ion with an `resources/datomic/ion-config.edn` that consists of a map of the `:app-name` of your application.
...
- [A data-driven application via AWS Lambda](../07-entry-points/entry-points.md#invoke-lambda)
- [Attribute predicates](../07-entry-points/entry-points.md#attribute-predicate)
