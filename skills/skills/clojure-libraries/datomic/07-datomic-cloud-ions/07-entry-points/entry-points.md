...
<a id="outline-container-http-direct"></a>

<a id="http-direct"></a>

## HTTP Direct

<a id="text-http-direct"></a>

Invoking an Ion via HTTP Direct is a simple HTTP request.

Find your `IonApiGatewayEndpoint` in your compute group's CloudFormation [template outputs](../../05-operation/02-cloud/11-how-to/how-to.md#template-outputs).
