...
- [deploy entire applications to Datomic with ions](../../../07-datomic-cloud-ions/01-ions-overview/ions-overview.md)
- [SQL analytics support](../../../08-analytics/01-analytics-concepts/analytics-concepts.md)
...
The Datomic Client API can [create, list, and delete databases](../../../04-apis/04-client-api/additional-client-api-reference/additional-client-api-reference.md#catalog-operations).

<a id="outline-container-acid-transactions"></a>

<a id="acid-transactions"></a>

## ACID Transactions

<a id="text-acid-transactions"></a>

Databases are [indelible](../02-datomic-data-model/datomic-data-model.md#indelible), and all new information is added by fully serialized ACID transactions. The `transact` operation takes as its arguments
...
For more information, see [transactions](../../02-transactions/02-transaction-data/transaction-data.md).

<a id="outline-container-installing-schema"></a>

<a id="installing-schema"></a>

## Installing Schema

<a id="text-installing-schema"></a>

[Schema](../../01-schema/01-schema-reference/schema-reference.md#defining-schema) attributes are ordinary entities in a database, and are added via ACID transactions just like any other data. Schema attributes must be defined in a transaction prior to any transaction that uses them.
...
Datomic's [query](../../03-query-and-pull/02-query-reference/query-reference.md) and rules system is an extended form of Datalog. Datalog is a deductive query system, typically consisting of:
...
<a id="outline-container-simple"></a>
...
<a id="outline-container-declarative"></a>

<a id="declarative"></a>

### Declarative

<a id="text-declarative"></a>
...
<a id="outline-container-logic-based"></a>

<a id="logic-based"></a>

### Logic-based

<a id="text-logic-based"></a>
...
<a id="outline-container-time-operations"></a>

<a id="time-operations"></a>

## Time

<a id="text-time-operations"></a>

Datomic is [indelible](../02-datomic-data-model/datomic-data-model.md#indelible), remembering the history of all information. The `db` operation returns the current value of a database. This value can then be filtered:
...
For more information, see [time](../../../04-apis/09-log-api/log-api.md).

<a id="outline-container-raw-indexes"></a>

<a id="raw-indexes"></a>

## Raw Indexes

<a id="text-raw-indexes"></a>
...
For more information, see [indexes](../../../04-apis/07-index-apis/index-apis.md).
