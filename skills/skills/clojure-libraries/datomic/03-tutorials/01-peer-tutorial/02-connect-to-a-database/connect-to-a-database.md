...
<a id="outline-container-create-db"></a>

<a id="create-db"></a>

## Creating a Database

<a id="text-create-db"></a>
...
The Datomic Peer API [names databases](../../../04-apis/01-peer-api-clojuredoc/peer-api-clojuredoc.md#datomic.api/connect) with a URI that includes the protocol name, storage connection information, and a database name. The complete URI for a database named "hello" on the [transactor you started in the previous step](../01-run-a-transactor/run-a-transactor.md) is `"datomic:dev://localhost:4334/hello"`.
...
<a id="outline-container-interact"></a>

<a id="interact"></a>

## Interact with Datomic

<a id="text-interact"></a>
