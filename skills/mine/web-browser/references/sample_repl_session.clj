...
(comment
  *e
  (e/with-chrome-headless driver
    ...
    ;; What's its title? The first <th> in the infobox holds the title:
    (e/get-element-text driver {:css "table.infobox.vevent th"})
    ;; => "Clojure"

    ;; Maybe we are interested in what value the infobox holds for the Family row.
    ;; We can iterate rows and match on the header text:
