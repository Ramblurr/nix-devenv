...
<a id="outline-container-operations"></a>

<a id="operations"></a>

## Stack Operations

<a id="text-operations"></a>

You can [create](#create), [update](#update), or [delete](#delete) a compute group.

<a id="outline-container-create"></a>
...
<a id="outline-container-update"></a>
...
- Select an existing compute group stack

in [CloudFormation](http://console.aws.amazon.com/cloudformation/home?#/stacks?filter=active)
...
<a id="outline-container-delete"></a>
...
- AWS EC2 key pair: [key pair](../../../01-setup/02-cloud-setup/01-aws-account-setup/aws-account-setup.md#ec2-keypair) for ssh access to nodes.
