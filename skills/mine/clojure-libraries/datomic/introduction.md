...
<a id="outline-container-about"></a>
...
1.  [**Information model:**](#information-model) Datomic’s information model, and how that model maps to real-world use cases
2.  [**Architecture:**](#architecture) the philosophy behind Datomic, Datomic’s key data structures, and the topologies of Datomic deployment
3.  [**Datomic editions:**](#datomic-editions) a comparison of Datomic Local, Datomic Pro, and Datomic Cloud
4.  [**Datomic APIs:**](#datomic-APIs) a comparison of Datomic’s peer and client APIs

For many people, the most efficient way to begin learning Datomic is to read this overview in its entirety, following the links to the reference for more detail as needed. If you prefer a more hands-on introduction, start with the [tutorial](03-tutorials/01-peer-tutorial/peer-tutorial.md) using the Datomic Pro peer library.

<a id="outline-container-information-model"></a>

<a id="information-model"></a>

## Information Model

<a id="text-information-model"></a>
...
<a id="outline-container-benefits"></a>

<a id="benefits"></a>

### Benefits

<a id="text-benefits"></a>
...
<a id="outline-container-tradeoffs"></a>

<a id="tradeoffs"></a>

### Tradeoffs

<a id="text-tradeoffs"></a>
...
<a id="outline-container-architecture"></a>

<a id="architecture"></a>

## Architecture

<a id="text-architecture"></a>
...
<a id="outline-container-inspired"></a>

<a id="inspired"></a>

### Inspired by Clojure

<a id="text-inspired"></a>
...
<a id="outline-container-data-structures"></a>

<a id="data-structures"></a>

## Data Structures

<a id="text-data-structures"></a>
...
- **Indelible:** The log accumulates new information and never removes existing information. Where update-in-place databases would delete, Datomic instead adds a new [retraction](06-reference/02-transactions/02-transaction-data/transaction-data.md).
...
- **Tangible:** The log in Datomic is not just an implementation detail; it is an integral part of Datomic's information model. You can query the log using the [log API](04-apis/09-log-api/additional-log-api/additional-log-api.md).

<a id="outline-container-topology"></a>

<a id="topology"></a>

## Topology

<a id="text-topology"></a>
...
[![topology-abstract.png](images/topology-abstract.png)](images/topology-abstract.png)
...
<a id="outline-container-datomic-editions"></a>

<a id="datomic-editions"></a>

## Datomic Editions

<a id="text-datomic-editions"></a>
...
<a id="outline-container-datomic-APIs"></a>

<a id="datomic-APIs"></a>

## Datomic APIs

<a id="text-datomic-APIs"></a>
...
<a id="outline-container-get-started"></a>

<a id="get-started"></a>

## Get Started

<a id="text-get-started"></a>

Great! Now you have read the overview! What next? We recommend that you continue to [Pro setup](01-setup/01-pro-setup/pro-setup.md), and learn how to access Datomic by [installing the peer API](02-accessing/01-peer-library/peer-library.md), and then completing the [peer tutorial](03-tutorials/01-peer-tutorial/peer-tutorial.md).
