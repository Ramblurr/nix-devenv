...
<a id="outline-container-datomic-schema"></a>

<a id="datomic-schema"></a>

## Datomic Schema Best Practices

<a id="text-datomic-schema"></a>
...
<a id="outline-container-production-schema"></a>

<a id="production-schema"></a>

## Datomic Production Schema Best Practices

<a id="text-production-schema"></a>
...
<a id="outline-container-datomic-transaction"></a>

<a id="datomic-transaction"></a>

## Datomic Transaction Best Practices

<a id="text-datomic-transaction"></a>
...
- [Use DbAfter to check the result of a transaction](#use-dbafter)
- [Set TxInstant on imports](#set-txinstant-on-imports)
- [Pipeline transactions for higher throughput](#pipeline-transactions)

<a id="outline-container-datomic-query"></a>

<a id="datomic-query"></a>

## Datomic Query Best Practices

<a id="text-datomic-query"></a>
...
<a id="outline-container-datomic-time"></a>

<a id="datomic-time"></a>

## Datomic Time Best Practices

<a id="text-datomic-time"></a>
...
<a id="outline-container-group-related-attributes"></a>

<a id="group-related-attributes"></a>

## Group Related Attributes in a Namespace

<a id="text-group-related-attributes"></a>
...
<a id="outline-container-plan-for-accretion"></a>

<a id="plan-for-accretion"></a>

## Plan for Accretion

<a id="text-plan-for-accretion"></a>
...
<a id="outline-container-one-direction-only"></a>

<a id="one-direction-only"></a>

## Model Relationships in One Direction Only

<a id="text-one-direction-only"></a>
...
<a id="outline-container-idents-for-enumerated-types"></a>

<a id="idents-for-enumerated-types"></a>

## Use Idents for Enumerated Types

<a id="text-idents-for-enumerated-types"></a>
...
<a id="outline-container-unique-ids-for-external-keys"></a>

<a id="unique-ids-for-external-keys"></a>

## Use Unique Identities for External Keys

<a id="text-unique-ids-for-external-keys"></a>
...
<a id="outline-container-nohistory-for-high-churn"></a>

<a id="nohistory-for-high-churn"></a>

## Use NoHistory for High-Churn Attributes

<a id="text-nohistory-for-high-churn"></a>
...
<a id="outline-container-grow-schema"></a>

<a id="grow-schema"></a>

## Grow Schema and Never Break It

<a id="text-grow-schema"></a>
...
<a id="outline-container-never-remove-or-reuse"></a>

<a id="never-remove-or-reuse"></a>

## Never Remove or Reuse Names

<a id="text-never-remove-or-reuse"></a>
...
<a id="outline-container-use-aliases"></a>

<a id="use-aliases"></a>

## Use Aliases

<a id="text-use-aliases"></a>
...
<a id="outline-container-annotate-schema"></a>

<a id="annotate-schema"></a>

## Annotate Schema

<a id="text-annotate-schema"></a>
...
<a id="outline-container-add-facts-about-transaction-entity"></a>

<a id="add-facts-about-transaction-entity"></a>

## Add Facts About the Transaction Entity

<a id="text-add-facts-about-transaction-entity"></a>
...
<a id="outline-container-lookup-refs-to-specify-existing-entities"></a>

<a id="lookup-refs-to-specify-existing-entities"></a>

## Use Lookup Refs to Specify Existing Entities

<a id="text-lookup-refs-to-specify-existing-entities"></a>
...
<a id="outline-container-optimistic-concurrency"></a>

<a id="optimistic-concurrency"></a>

## Use CAS for Optimistic Concurrency

<a id="text-optimistic-concurrency"></a>
...
<a id="outline-container-use-dbafter"></a>

<a id="use-dbafter"></a>

## Use DbAfter to see the Result of a Transaction

<a id="text-use-dbafter"></a>
...
<a id="outline-container-set-txinstant-on-imports"></a>

<a id="set-txinstant-on-imports"></a>

## Set txInstant on Imports

<a id="text-set-txinstant-on-imports"></a>
...
- You should choose `:db/txInstant` not newer than the transactor's clock time; otherwise the transactor will be unable to add data until the wall clock catches up
...
<a id="outline-container-pipeline-transactions"></a>

<a id="pipeline-transactions"></a>

## Pipeline Transactions for Higher Throughput

<a id="text-pipeline-transactions"></a>
...
<a id="outline-container-most-selective-clauses-first"></a>

<a id="most-selective-clauses-first"></a>

## Put the Most Selective Clause First in Query

<a id="text-most-selective-clauses-first"></a>
...
<a id="outline-container-join-along"></a>

<a id="join-along"></a>

## Join Along

<a id="text-join-along"></a>
...
<a id="outline-container-prefer-query"></a>

<a id="prefer-query"></a>

## Prefer Query Over Raw Index Access

<a id="text-prefer-query"></a>
...
<a id="outline-container-collections-as-inputs"></a>

<a id="collections-as-inputs"></a>

## Pass Collections as Inputs

<a id="text-collections-as-inputs"></a>
...
<a id="outline-container-use-pull-to-retrieve-attribute-values"></a>

<a id="use-pull-to-retrieve-attribute-values"></a>

## Use Pull to Retrieve Attribute Values

<a id="text-use-pull-to-retrieve-attribute-values"></a>
...
<a id="outline-container-blanks-in-data-patterns"></a>

<a id="blanks-in-data-patterns"></a>

## Put Blanks in Data Patterns

<a id="text-blanks-in-data-patterns"></a>
...
<a id="outline-container-parameterize-queries"></a>

<a id="parameterize-queries"></a>

## Use Query Inputs to Parameterize Queries and Leverage Caching

<a id="text-parameterize-queries"></a>

Datomic [caches](../03-query-and-pull/01-executing-queries/executing-queries.md) queries, so long as the query argument data structures are evaluated as equal. As a result, reusing parameterized queries is much more efficient than building different query data structures. If you need to build data structures at run time for a query, do so using a standard process so that equivalent queries will be evaluated as equal.
...
<a id="outline-container-work-with-data-structures"></a>

<a id="work-with-data-structures"></a>

## Work with Data Structures, Not Strings

<a id="text-work-with-data-structures"></a>
...
<a id="outline-container-consistent-db-value-for-unit-of-work"></a>

<a id="consistent-db-value-for-unit-of-work"></a>

## Use a Consistent Db Value for a Unit of Work

<a id="text-consistent-db-value-for-unit-of-work"></a>
...
<a id="outline-container-t-instead-of-txInstant"></a>

<a id="t-instead-of-txInstant"></a>

## Specify t Instead of txInstant for Precise asOf Locations

<a id="text-t-instead-of-txInstant"></a>
...
<a id="outline-container-use-history"></a>

<a id="use-history"></a>

## Use the History Filter for Audit Trail Queries

<a id="text-use-history"></a>
...
<a id="outline-container-multiple-points-in-time"></a>

<a id="multiple-points-in-time"></a>

## Pass Multiple Points-in-time to a Single Query

<a id="text-multiple-points-in-time"></a>
...
<a id="outline-container-use-log-api"></a>

<a id="use-log-api"></a>

## Use the Log API If Time Is Your Most Selective Criterion

<a id="text-use-log-api"></a>

If you are most interested in retrieving values by or at specific times, the [log API](../../04-apis/09-log-api/additional-log-api/additional-log-api.md) is the appropriate (and most efficient) way to do so. The log is ordered by transaction time and provides fast lookup by T.
