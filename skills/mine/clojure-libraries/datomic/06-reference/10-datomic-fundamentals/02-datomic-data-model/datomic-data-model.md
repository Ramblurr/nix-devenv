...
<a id="datomic-data-model"></a>

# Datomic Data Model

A Datomic [database](#database) is a set of immutable atomic facts called [datoms](#datoms). A database contains no tables; rather, there is a [universal schema](#universal) of user-defined attributes. Any [entity](#entities) can possess any attribute.

Datomic [datalog queries](../03-supported-operations/supported-operations.md#datalog) automatically use multiple [indexes](../../../05-operation/02-cloud/01-cloud-architecture/cloud-architecture.md#indexes) to support a variety of access patterns. In addition to supporting query, these indexes support [identity and uniqueness](#identity-and-uniqueness), an indelible [time model](#time-model), and [lookup refs](#lookup-refs).

[Day of Datomic Cloud](https://www.youtube.com/watch?v=ZP-E2IgqKfA) contains a video overview of Datomic's Information Model.
...
<a id="outline-container-example-datom"></a>

<a id="example-datom"></a>

### Example Datom

<a id="text-example-datom"></a>
...
<a id="outline-container-entities"></a>

<a id="entities"></a>

## Entities

<a id="text-entities"></a>

An *entity* is a set of *datoms* that are all about the same E.

<a id="outline-container-example-entity"></a>

<a id="example-entity"></a>

### Example Entity

<a id="text-example-entity"></a>
...
<a id="outline-container-point-in-time-entity-example"></a>

<a id="point-in-time-entity-example"></a>

### Point-In-Time Entity Example

<a id="text-point-in-time-entity-example"></a>
...
<a id="outline-container-map-view-example"></a>

<a id="map-view-example"></a>

### Map View Example

<a id="text-map-view-example"></a>
...
<a id="outline-container-universal"></a>

<a id="universal"></a>

## Universal Schema

<a id="text-universal"></a>
...
For example, consider storing an inventory database in Datomic. All inventory items have a unique string identifier, so you create an `:inv/id` attribute. In addition, you create other named attributes, specifying the [types](../../01-schema/01-schema-reference/schema-reference.md#db-valuetype) and [cardinalities](../../01-schema/01-schema-reference/schema-reference.md#db-cardinality) of each.
...
For more information see the [schema documentation](../../01-schema/01-schema-reference/schema-reference.md).

<a id="outline-container-time-model"></a>

<a id="time-model"></a>

## Time Model

<a id="text-time-model"></a>
...
- Every datom in the database includes the id of the transaction that added that datom.
...
<a id="outline-container-time-model-2"></a>

<a id="time-model-2"></a>

### Time Model

<a id="text-time-model-2"></a>
...
For more information, see the [Datomic Time Model Documentation](../../../04-apis/09-log-api/log-api.md).

<a id="outline-container-identity-and-uniqueness"></a>

<a id="identity-and-uniqueness"></a>

## Identity and Uniqueness

<a id="text-identity-and-uniqueness"></a>

Datomic provides a number of tools for dealing with identity and uniqueness.

- When you create a datom, Datomic automatically assigns it a database-unique number called an [entity id](../../01-schema/01-schema-reference/schema-reference.md#db-id).

- The built-in [:db/ident attribute](../../01-schema/01-schema-reference/schema-reference.md#db-ident) can be used for programmatic names.

- The built-in [:db/unique attribute](../../01-schema/01-schema-reference/schema-reference.md#db-unique) can be added at any time. The uniqueness properties of an existing attribute also can be changed at any time (so long as the uniqueness properties are valid for the data). The :db/unique attribute can be used in the following ways:
...
<a id="outline-container-lookup-refs"></a>

<a id="lookup-refs"></a>

## Lookup Refs

<a id="text-lookup-refs"></a>
...
- Lookup refs cannot be used in the body of a query though they can be used as inputs to a [parameterized query](../../03-query-and-pull/01-executing-queries/executing-queries.md).

<a id="outline-container-indelible"></a>

<a id="indelible"></a>

## Indelible and Chronological

<a id="text-indelible"></a>
