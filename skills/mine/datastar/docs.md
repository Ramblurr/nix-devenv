...
- [Attributes](#attributes)
  - [-](#-)
  - [`data-bind` ](#data-bind-1)
    - [Predefined Signal Types](#predefined-signal-types)
    - [File Uploads](#file-uploads)
    - [Modifiers](#modifiers)
    - [`data-class` ](#data-class-1)
      - [Modifiers](#modifiers-1)
    - [`data-computed` ](#data-computed-1)
  ...
  - [Pro Attributes ](#pro-attributes)
    - [`data-animate` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-animate-prohttpsdata-stardevpro-datastar-pro)
    - [`data-custom-validity` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-custom-validity-prohttpsdata-stardevpro-datastar-pro)
    - [`data-match-media` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-match-media-prohttpsdata-stardevpro-datastar-pro)
      - [Modifiers](#modifiers-13)
    - [`data-on-raf` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-on-raf-prohttpsdata-stardevpro-datastar-pro)
      - [Modifiers](#modifiers-14)
    - [`data-on-resize` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-on-resize-prohttpsdata-stardevpro-datastar-pro)
      - [Modifiers](#modifiers-15)
    - [`data-persist` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-persist-prohttpsdata-stardevpro-datastar-pro)
      - [Modifiers](#modifiers-16)
    - [`data-query-string` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-query-string-prohttpsdata-stardevpro-datastar-pro)
      - [Modifiers](#modifiers-17)
    - [`data-replace-url` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-replace-url-prohttpsdata-stardevpro-datastar-pro)
    - [`data-scroll-into-view` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-scroll-into-view-prohttpsdata-stardevpro-datastar-pro)
      - [Modifiers](#modifiers-18)
    - [`data-view-transition` [Pro](https://data-star.dev/pro "Datastar Pro")](#data-view-transition-prohttpsdata-stardevpro-datastar-pro)
  ...
  - [Datastar Expressions ](#datastar-expressions-1)
  - [Error Handling ](#error-handling)
- [Actions](#actions)
  - [-](#--1)
  - [`@setAll()` ](#setall)
  - [`@toggleAll()` ](#toggleall)
  - [Backend Actions ](#backend-actions-1)
    - [`@get()` ](#get)
    - [`@post()` ](#post)
    - [`@put()` ](#put)
    - [`@patch()` ](#patch)
  ...
  - [Pro Actions ](#pro-actions)
    - [`@clipboard()` [Pro](https://data-star.dev/pro "Datastar Pro")](#clipboard-prohttpsdata-stardevpro-datastar-pro)
    - [`@fit()` [Pro](https://data-star.dev/pro "Datastar Pro")](#fit-prohttpsdata-stardevpro-datastar-pro)
    - [`@intl()` [Pro](https://data-star.dev/pro "Datastar Pro")](#intl-prohttpsdata-stardevpro-datastar-pro)
- [Rocket](#rocket)
  - [Overview ](#overview)
    - [`tag` ](#tag)
  - [Definition ](#definition)
    - [`mode` ](#mode)
    - [`props` ](#props)
    - [Props vs Signals ](#props-vs-signals)
    - [`manifest` ](#manifest)
    - [`setup` ](#setup)
  ...
  - [Props and Codecs ](#props-and-codecs)
    - [How Props Flow ](#how-props-flow)
    - [Fluent Codec Pattern ](#fluent-codec-pattern)
    - [Custom Codecs ](#custom-codecs)
    - [Codec Tables ](#codec-tables)
    - [`string` ](#string)
    - [`number` ](#number)
    - [`bool` ](#bool)
    - [`date` ](#date)
    ...
    - [`object` ](#object)
    - [`oneOf` ](#oneof)
  - [Setup and Actions ](#setup-and-actions)
    - [Setup Context ](#setup-context)
    - [Host Accessor Overrides ](#host-accessor-overrides)
    - [Watching Attribute Changes ](#watching-attribute-changes)
  - [Rendering and Scoping ](#rendering-and-scoping)
    - [Render Contract ](#render-contract)
    - [Render Example: Counter ](#render-example-counter)
    - [Render Example: List Rendering ](#render-example-list-rendering)
    - [Render Example: SVG ](#render-example-svg)
