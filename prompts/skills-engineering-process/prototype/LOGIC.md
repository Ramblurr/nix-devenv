...
Use whatever the host project uses. If the project has no obvious runtime (e.g. a docs repo), ask. If it is a Clojure project, consider using Babashka if we don't need to import java libs.
