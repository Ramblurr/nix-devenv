...
Follow the project's language-specific guides when mapping modules, interfaces,
implementations, and seams onto language constructs or files.
...
- **"Interface" as a language keyword or a type's public methods**: too narrow — interface here includes every fact a caller must know.
