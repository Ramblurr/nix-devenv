...
**Not every skill requires all three types of resources. Create resource directories only when they will actually be used, and do not leave empty directories behind.**
"""
