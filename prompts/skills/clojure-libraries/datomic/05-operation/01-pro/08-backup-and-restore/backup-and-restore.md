...
<a id="outline-container-backing-up"></a>

<a id="backing-up"></a>

## Backing Up

<a id="text-backing-up"></a>
...
Give the backup process at least as much memory as [the transactor process is given](../05-capacity-planning/capacity-planning.md#transactor-memory) for a system, or approximately 500MB per billion datoms, whichever value is higher.
...
<a id="outline-container-differential-backup"></a>

<a id="differential-backup"></a>

### Differential Backup

<a id="text-differential-backup"></a>
...
<a id="outline-container-listing-backups"></a>

<a id="listing-backups"></a>

## Listing Backups

<a id="text-listing-backups"></a>
...
<a id="outline-container-restoring"></a>

<a id="restoring"></a>

## Restoring

<a id="text-restoring"></a>
...
You should give the restore process as much memory as you [give the transactor process](../05-capacity-planning/capacity-planning.md#transactor-memory) for that system.
...
<a id="outline-container-dev-and-free-storages"></a>

<a id="dev-and-free-storages"></a>

### Restoring to :dev Storage

<a id="text-dev-and-free-storages"></a>
...
<a id="outline-container-verifying-backups"></a>

<a id="verifying-backups"></a>

## Verifying Backups

<a id="text-verifying-backups"></a>
...
<a id="outline-container-reading"></a>

<a id="reading"></a>

## Reading from Backups

<a id="text-reading"></a>

The datomic:backup: protocol accepts any backup location described in the [URI section](#uri-syntax). You can use list-backups to get the `datomic:backup:` protocol uri and a list of all the \`t\`'s it contains. These URI represent connectable db values and can be used for any read only workflow. For more information see our documentation on [read only connections](../02-read-only-connections/read-only-connections.md)

<a id="outline-container-performance"></a>

<a id="performance"></a>

## Backup, Restore, and Verify Performance

<a id="text-performance"></a>

Backup, restore, and verify performance can be configured through [system properties](../11-system-properties/system-properties.md#backup-properties).

<a id="outline-container-deleting-backups"></a>

<a id="deleting-backups"></a>

## Deleting Backups

<a id="text-deleting-backups"></a>
...
- Java - [Peer.connect()](../../../04-apis/02-peer-api-javadoc/classes/peer/peer.md)
- Clojure - [datomic.api/connect](../../../04-apis/01-peer-api-clojuredoc/peer-api-clojuredoc.md#datomic.api/connect)

<a id="outline-container-aws-permissions"></a>

<a id="aws-permissions"></a>

## AWS Permissions

<a id="text-aws-permissions"></a>

When backing up from DDB, the required AWS permissions are the same as those a Peer would use, i.e. storage read-only. However, when restoring to DDB, the AWS permissions should be those used by the transactor, i.e. read/write credentials. Check [AWS access control](../14-aws-access-control/aws-access-control.md) for information on providing the backup/restore processes access to the necessary resources.

<a id="outline-container-iam-role-policies"></a>

<a id="iam-role-policies"></a>

### IAM Role Policies

<a id="text-iam-role-policies"></a>
