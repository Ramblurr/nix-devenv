...
> Do **not** delete [region-wide shared resources](#region-wide-resources).

<a id="outline-container-deleting-stacks"></a>

<a id="deleting-stacks"></a>

## Deleting CloudFormation Stacks

<a id="text-deleting-stacks"></a>
...
> You can delete CloudFormation stacks at any time, with no loss of data. You might do this e.g. to save computing costs for a system not in active use. To recreate the stacks later, simply follow the [recreate storage](../16-splitting-stacks/splitting-stacks.md) and [recreate compute](../16-splitting-stacks/splitting-stacks.md) instructions.
...
<a id="outline-container-single-template-system"></a>

<a id="single-template-system"></a>

### Single Template System

<a id="text-single-template-system"></a>

If you followed the initial Setting Up instructions and have never upgraded, your system will have a single top-level CloudFormation stack whose name is the system name. Delete this stack.

<a id="outline-container-multiple-template-systems"></a>

<a id="multiple-template-systems"></a>

### Multiple Template Systems

<a id="text-multiple-template-systems"></a>
...
<a id="outline-container-deleting-storage"></a>

<a id="deleting-storage"></a>

## Deleting Durable Storage

<a id="text-deleting-storage"></a>
...
- Delete any [custom API Gateways](../08-customizing-api-gateways/customizing-api-gateways.md#creating-your-apigateway). You will need to:
...
<a id="outline-container-region-wide-resources"></a>

<a id="region-wide-resources"></a>

## Region-wide Shared Resources

<a id="text-region-wide-resources"></a>
...
Delete these resources only after deleting all Datomic systems in a region.

> The [ion code bucket](../11-how-to/how-to.md#ion-code-bucket) is tagged with `datomic:code`.
...
<a id="outline-container-sg-dependent-object"></a>

<a id="sg-dependent-object"></a>

#### resource sg-\<uuid\> has a dependent object

<a id="text-sg-dependent-object"></a>
...
**Correcting the error** This usually occurs when you've deployed an Ion to this system. To solve it:
...
<a id="outline-container-the-following-resource-s-failed-to-delete-vpclinksecuritygroup-vpclink"></a>

<a id="the-following-resource-s-failed-to-delete-vpclinksecuritygroup-vpclink"></a>

#### The following resource(s) failed to delete: \[VpcLinkSecurityGroup, VpcLink\].\\

<a id="text-the-following-resource-s-failed-to-delete-vpclinksecuritygroup-vpclink"></a>
