...
High Availability (HA) is a Datomic Cloud feature ensuring the availability of a [compute group](../01-cloud-architecture/cloud-architecture.md) for reads and writes in the event of node failures.
...
<a id="outline-container-enabling-ha"></a>

<a id="enabling-ha"></a>

## Enabling HA

<a id="text-enabling-ha"></a>
...
<a id="outline-container-how-ha-works"></a>

<a id="how-ha-works"></a>

## How HA Works

<a id="text-how-ha-works"></a>
...
<a id="outline-container-without-ha"></a>

<a id="without-ha"></a>

## Running Without HA

<a id="text-without-ha"></a>
...
The time window to replace a node is usually [less than five minutes](https://aws.amazon.com/ec2/autoscaling/faqs/) at the EC2 level. If that recovery window (plus any application-specific startup time) is sufficient for your availability needs, then you can choose to run a compute group without HA.

<a id="outline-container-multiple groups"></a>

<a id="multiple groups"></a>

## Running Multiple Compute Groups

<a id="text-multiple groups"></a>
...
<a id="outline-container-primary-compute"></a>

<a id="primary-compute"></a>

## Primary Group Determines Availability for Transactions

<a id="text-primary-compute"></a>
...
When a node becomes unhealthy for any reason, client requests that are routed from the ALB to that node may experience slow responses or transient `unavailable` [anomalies](../../../04-apis/04-client-api/additional-client-api-reference/additional-client-api-reference.md#anomalies). The client requests that reach one of the other, healthy nodes during this time will experience normal behavior and performance.
