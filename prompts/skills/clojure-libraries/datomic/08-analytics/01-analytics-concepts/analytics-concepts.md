...
<a id="analytics-support-preview"></a>

# Analytics Support (Preview)

<a id="outline-container-concept"></a>
...
There is native Presto protocol support for [Python](../09-python/python.md), [R](../08-r/r.md), [Metabase](../07-metabase/metabase.md), [Superset](../11-superset/superset.md), [Tableau, and more](../13-other-tools/other-tools.md). Presto also supports [JDBC](../13-other-tools/other-tools.md) for integration with Java-based analytics tooling. In short, if you are looking to connect an analytics tool to Datomic, you will look for the *Presto* connector, or use JDBC.

[![analytics.png](../../images/analytics.png)](../../images/analytics.png)

<a id="outline-container-sql-mapping"></a>

<a id="sql-mapping"></a>

## SQL Mapping

<a id="text-sql-mapping"></a>
...
<a id="outline-container-metaschemas"></a>

<a id="metaschemas"></a>

## Metaschemas

<a id="text-metaschemas"></a>
...
<a id="outline-container-membership-attrs"></a>

<a id="membership-attrs"></a>

### Membership Attributes

<a id="text-membership-attrs"></a>
...
<a id="outline-container-ns-conventions"></a>

<a id="ns-conventions"></a>

### Namespace Conventions Determine (Default) Columns

<a id="text-ns-conventions"></a>
...
<a id="outline-container-column-joins"></a>

<a id="column-joins"></a>

### Column Joins - More Denormalizing Power

<a id="text-column-joins"></a>
...
For example, if there was a "country" table based on `:country/code` containing columns "code" and "name" for `:country/code` and `:country/name`, and a ref attr called `:product/country`, there would be an integer column in the "product" table called "country", containing the id of a country. Adding an entry in the `:joins` map of `{:product/country "country"}` would add "country\_\_code" and "country\_\_name" columns to the "product" table.

Check the [Metaschema reference](../05-metaschema/metaschema.md) for more details.

<a id="outline-container-one-metaschema"></a>

<a id="one-metaschema"></a>

### One Metaschema per Datomic *Schema*

<a id="text-one-metaschema"></a>
...
<a id="outline-container-virtual"></a>
...
<a id="outline-container-preview"></a>
