...
- [Processing transactions](03-processing-transactions/processing-transactions.md): what happens when you call [d/transact](../../04-apis/01-peer-api-clojuredoc/peer-api-clojuredoc.md#datomic.api/transact)
