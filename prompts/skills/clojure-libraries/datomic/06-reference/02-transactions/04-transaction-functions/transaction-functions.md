...
<a id="outline-container-semantics"></a>

<a id="semantics"></a>

## Transaction Function Semantics

<a id="text-semantics"></a>
...
Transaction functions support the operation of [d/with](../01-transaction-model/transaction-model.md#with-and-transact), which is also a pure function `[db-before, tx-data] -> tx-data`. d/with calls transaction functions to augment tx-data, producing more tx-data:
...
<a id="outline-container-when-to-use"></a>

<a id="when-to-use"></a>

## When to use transaction functions

<a id="text-when-to-use"></a>
...
| single / multi value attribute | attribute [cardinality](../../01-schema/01-schema-reference/schema-reference.md) |
...
| predicates and transformations of transaction data, given db-before | [custom transaction function](#types) |
| sagas | [sync](../06-client-synchronization/client-synchronization.md#sync) and [as-of](../06-client-synchronization/client-synchronization.md#comparison) |

<a id="outline-container-performance-and-security"></a>

<a id="performance-and-security"></a>

## Performance and Security

<a id="text-performance-and-security"></a>
...
<a id="outline-container-types"></a>
...
<a id="outline-container-invoking"></a>

<a id="invoking"></a>

## Invoking Transaction Functions

<a id="text-invoking"></a>
...
Transaction functions can abort a transaction for any reason whatsoever by calling [`cancel`](../../../04-apis/01-peer-api-clojuredoc/peer-api-clojuredoc.md#datomic.api/cancel), or they can [expand](../02-transaction-data/transaction-data.md#tx-data) to (possibly empty) data that will be included in the transaction.
...
<a id="outline-container-built-in"></a>

<a id="built-in"></a>

## Built-In Transaction Functions

<a id="text-built-in"></a>

The following transaction functions are automatically included in Datomic for you to use.

<a id="outline-container-dbfn-retractentity"></a>

<a id="dbfn-retractentity"></a>

### `:db/retractEntity`

<a id="text-dbfn-retractentity"></a>
...
<a id="outline-container-dbfn-cas"></a>

<a id="dbfn-cas"></a>

### `:db/cas`

<a id="text-dbfn-cas"></a>
...
<a id="outline-container-dbfn-force-partition"></a>

<a id="dbfn-force-partition"></a>

### `:db/force-partition`

<a id="text-dbfn-force-partition"></a>

The [`:db/force-partition`](../07-partitions/partitions.md#force-partition) function takes a map of tempids to desired partitions.

<a id="outline-container-dbfn-match-partition"></a>

<a id="dbfn-match-partition"></a>

### `:db/match-partition`

<a id="text-dbfn-match-partition"></a>

The [`:db/match-partition`](../07-partitions/partitions.md#match-partition) function takes a map of tempids to entities that are in desired partitions.

<a id="outline-container-writing"></a>
...
<a id="outline-container-canceling"></a>

<a id="canceling"></a>

## Canceling a transaction

<a id="text-canceling"></a>
...
<a id="outline-container-testing"></a>
...
<a id="outline-container-deploying-db-fns"></a>

<a id="deploying-db-fns"></a>

### Deploying Database Functions

<a id="text-deploying-db-fns"></a>
...
<a id="outline-container-deploying-classpath-fns"></a>

<a id="deploying-classpath-fns"></a>

### Deploying Classpath Functions

<a id="text-deploying-classpath-fns"></a>
