...
<a id="outline-container-transaction-grammar"></a>

<a id="transaction-grammar"></a>

## Transaction Data Grammar

<a id="text-transaction-grammar"></a>

<a id="outline-container-syntax"></a>
...
<a id="outline-container-tx-data"></a>
...
Datomic represents transaction data as [data structures](../../09-data-structure-literals/data-structure-literals.md). This is a significant difference from SQL databases, where requests are submitted as strings. Using data instead of strings makes it easier to build requests programmatically.
...
<a id="outline-container-list-forms"></a>

<a id="list-forms"></a>

## Assert and Retract

<a id="text-list-forms"></a>
...
<a id="outline-container-redundancy-elimination"></a>

<a id="redundancy-elimination"></a>

### Redundancy Elimination

<a id="text-redundancy-elimination"></a>
...
<a id="outline-container-map-forms"></a>

<a id="map-forms"></a>

## Map Forms

<a id="text-map-forms"></a>
...
<a id="outline-container-nested-maps-in-transactions"></a>

<a id="nested-maps-in-transactions"></a>

### Nested Maps

<a id="text-nested-maps-in-transactions"></a>
...
Datomic requires that a nested map either be referenced by a [component attribute](../../01-schema/01-schema-reference/schema-reference.md#db-iscomponent) or include a [unique](../../01-schema/04-identity-and-uniqueness/identity-and-uniqueness.md) attribute. This constraint prevents the accidental creation of easily-orphaned entities that have no unique identity or relation to other entities.

<a id="outline-container-transaction-functions"></a>
...
<a id="outline-container-tempids"></a>
...
- a [lookup ref](#lookup-ref) for an entity that has a unique attribute
...
<a id="outline-container-reified-txes"></a>

<a id="reified-txes"></a>

## Reified Transactions

<a id="text-reified-txes"></a>
...
<a id="outline-container-explicit-db-txinstant"></a>

<a id="explicit-db-txinstant"></a>

### Explicit :db/txInstant

<a id="text-explicit-db-txinstant"></a>
