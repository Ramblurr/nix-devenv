...
<a id="outline-container-entity-identifiers"></a>

<a id="entity-identifiers"></a>

## Entity Identifiers

<a id="text-entity-identifiers"></a>
...
You can request new entity ids by specifying a temporary id (tempid) in transaction data. The [Peer.tempid](../../../04-apis/02-peer-api-javadoc/classes/peer/peer.md) method creates a new tempid, and the [Peer.resolveTempid](../../../04-apis/02-peer-api-javadoc/classes/peer/peer.md) method can be used to interrogate a transaction return value for the actual id assigned.

Internally, entity ids encode the partition an entity belongs to. An entity's partition may be useful in some cases, and can be discovered by calling [Peer.part](../../../04-apis/02-peer-api-javadoc/classes/peer/peer.md).

Transactions and partitions are discussed fully in [transactions](../../02-transactions/transactions.md).

<a id="outline-container-idents"></a>
...
- As the sole argument to [entity](../../../04-apis/02-peer-api-javadoc/interfaces/database/database.md).
- In the e, a, and v positions of assertions and retractions passed to [transact](../../../04-apis/02-peer-api-javadoc/interfaces/connection/connection.md) and [with](../../../04-apis/02-peer-api-javadoc/interfaces/database/database.md).
- In the e, a, and v positions of a [query](../../03-query-and-pull/query-and-pull.md).

There are some situations where Datomic cannot know that a keyword is an ident. For example, Datomic does not know the semantics of database functions written by you. If you need to convert between idents and entity ids in your own code, you can use the [ident](../../../04-apis/02-peer-api-javadoc/interfaces/database/database.md) and [entid](../../../04-apis/02-peer-api-javadoc/interfaces/database/database.md) methods on the *Database* class.

<a id="outline-container-unique-identities"></a>

<a id="unique-identities"></a>

## Unique Identities

<a id="text-unique-identities"></a>
...
Datomic does provide a mechanism to declare composite uniqueness constraints via [composite tuples](../01-schema-reference/schema-reference.md#composite-tuples).

<a id="outline-container-unique-values"></a>

<a id="unique-values"></a>

## Unique Values

<a id="text-unique-values"></a>
...
<a id="outline-container-squuids"></a>
...
- Lookup refs cannot be used in the body of a query though they can be used as [inputs in a parameterized query](../../03-query-and-pull/query-and-pull.md).
...
<a id="outline-container-joins-should-use-entity-ids"></a>

<a id="joins-should-use-entity-ids"></a>

## Joins Should Use Entity IDs

<a id="text-joins-should-use-entity-ids"></a>
...
Attributes of type *:db.type/bytes* cannot be unique and cannot be used as lookup refs. Check [bytes limitations](../01-schema-reference/schema-reference.md#bytes-limitations).
