...
<a id="schema-data-reference"></a>

# Schema Data Reference

This document defines the grammar for schema data.

<a id="outline-container-schema-grammar"></a>

<a id="schema-grammar"></a>

## Schema Grammar

<a id="text-schema-grammar"></a>
...
<a id="outline-container-schema-map-grammar"></a>

<a id="schema-map-grammar"></a>

### Schema Map Grammar

<a id="text-schema-map-grammar"></a>
...
<a id="outline-container-grammar-notes"></a>

<a id="grammar-notes"></a>

### Grammar Notes

<a id="text-grammar-notes"></a>
...
<a id="outline-container-defining-schema"></a>

<a id="defining-schema"></a>

## Defining Schema

<a id="text-defining-schema"></a>
...
<a id="outline-container-db-cardinality"></a>

<a id="db-cardinality"></a>

## `:db/cardinality`

<a id="text-db-cardinality"></a>
...
<a id="outline-container-db-doc"></a>
...
<a id="outline-container-db-fulltext"></a>

<a id="db-fulltext"></a>

## `:db/fulltext`

<a id="text-db-fulltext"></a>
...
<a id="outline-container-db-id"></a>
...
<a id="outline-container-db-ident"></a>

<a id="db-ident"></a>

## `:db/ident`

<a id="text-db-ident"></a>
...
<a id="outline-container-allowable-values"></a>

<a id="allowable-values"></a>

### Allowable Values

<a id="text-allowable-values"></a>
...
<a id="outline-container-db-iscomponent"></a>

<a id="db-iscomponent"></a>

## `:db/isComponent`

<a id="text-db-iscomponent"></a>
...
The optional `:db/isComponent` attribute specifies that an attribute whose [:db/valueType](#db-valuetype) is [`:db.type/ref`](#db-valuetype) refers to a sub-component of the entity to which the attribute is applied. When you retract an entity with [`:db.fn/retractEntity`](../../02-transactions/04-transaction-functions/transaction-functions.md), all sub-components are also retracted.

Omitting `:db/isComponent` for an entity is semantically equivalent to setting it to `false`.

<a id="outline-container-db-nohistory"></a>

<a id="db-nohistory"></a>

## `:db/noHistory`

<a id="text-db-nohistory"></a>

```
{':db/noHistory' boolean}
```

<a id="outline-container-description-and-use-cases"></a>

<a id="description-and-use-cases"></a>

### Description and Use Cases

<a id="text-description-and-use-cases"></a>
...
<a id="outline-container-db-unique"></a>

<a id="db-unique"></a>

## `:db/unique`

<a id="text-db-unique"></a>
...
<a id="outline-container-db-unique-identity"></a>

<a id="db-unique-identity"></a>

### `:db.unique/identity`

<a id="text-db-unique-identity"></a>
...
<a id="outline-container-db-valuetype"></a>

<a id="db-valuetype"></a>

## *:db/valueType*

<a id="text-db-valuetype"></a>
...
<a id="outline-container-notes-on-value-types"></a>

<a id="notes-on-value-types"></a>

### Notes on Value Types

<a id="text-notes-on-value-types"></a>
...
<a id="outline-container-tuples"></a>
...
<a id="outline-container-composite-tuples"></a>

<a id="composite-tuples"></a>

### Composite Tuples

<a id="text-composite-tuples"></a>
...
<a id="outline-container-adding-composite-existing"></a>

<a id="adding-composite-existing"></a>

### Adding Composites to Existing Entities

<a id="text-adding-composite-existing"></a>
...
<a id="outline-container-heterogeneous-tuples"></a>

<a id="heterogeneous-tuples"></a>

### Heterogeneous Tuples

<a id="text-heterogeneous-tuples"></a>
...
<a id="outline-container-homogeneous-tuples"></a>

<a id="homogeneous-tuples"></a>

### Homogeneous Tuples

<a id="text-homogeneous-tuples"></a>
...
<a id="outline-container-attribute-predicates"></a>

<a id="attribute-predicates"></a>

## Attribute Predicates

<a id="text-attribute-predicates"></a>
...
A transaction that includes an invalid `user-name` will result in an [incorrect anomaly](../../../04-apis/14-error-handling/error-handling.md) that includes:
...
<a id="outline-container-entity-specs"></a>

<a id="entity-specs"></a>

## Entity Specs

<a id="text-entity-specs"></a>
...
<a id="outline-container-required-attributes"></a>

<a id="required-attributes"></a>

### Required Attributes

<a id="text-required-attributes"></a>
...
<a id="outline-container-entity-predicates"></a>

<a id="entity-predicates"></a>

### Entity Predicates

<a id="text-entity-predicates"></a>
...
<a id="outline-container-number-of-schema-elements"></a>

<a id="number-of-schema-elements"></a>

### Number of Schema Elements

<a id="text-number-of-schema-elements"></a>
...
<a id="outline-container-schema-element-restrictions"></a>

<a id="schema-element-restrictions"></a>

### Schema Element Restrictions

<a id="text-schema-element-restrictions"></a>
...
<a id="outline-container-NaN-limitations"></a>

<a id="NaN-limitations"></a>

### Limitations of NaN

<a id="text-NaN-limitations"></a>
...
<a id="outline-container-bytes-limitations"></a>

<a id="bytes-limitations"></a>

### Limitations of Bytes

<a id="text-bytes-limitations"></a>
