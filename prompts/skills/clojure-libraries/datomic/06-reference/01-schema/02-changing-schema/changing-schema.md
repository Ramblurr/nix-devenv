...
<a id="outline-container-changing-db-ident"></a>

<a id="changing-db-ident"></a>

## Changing a `:db/ident`

<a id="text-changing-db-ident"></a>
...
<a id="outline-container-changing-db-cardinality"></a>

<a id="changing-db-cardinality"></a>

## Changing a `:db/cardinality` Attribute

<a id="text-changing-db-cardinality"></a>
...
<a id="outline-container-changing-db-iscomponent"></a>

<a id="changing-db-iscomponent"></a>

## Changing a `:db/isComponent` Attribute

<a id="text-changing-db-iscomponent"></a>
...
<a id="outline-container-changing-db-nohistory"></a>

<a id="changing-db-nohistory"></a>

## Changing a `:db/noHistory` Attribute

<a id="text-changing-db-nohistory"></a>
...
<a id="outline-container-adding-an-avet-index-to-an-attribute"></a>

<a id="adding-an-avet-index-to-an-attribute"></a>

## Adding an AVET index to an attribute

<a id="text-adding-an-avet-index-to-an-attribute"></a>
...
<a id="outline-container-removing-avet-index"></a>

<a id="removing-avet-index"></a>

## Removing an AVET index from an attribute

<a id="text-removing-avet-index"></a>
...
<a id="outline-container-changing-db-unique"></a>

<a id="changing-db-unique"></a>

## Changing a `:db/unique` Attribute

<a id="text-changing-db-unique"></a>
