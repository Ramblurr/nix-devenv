...
<a id="outline-container-query-grammar"></a>

<a id="query-grammar"></a>

## Query Grammar

<a id="text-query-grammar"></a>

<a id="outline-container-syntax-used-in-grammar"></a>

<a id="syntax-used-in-grammar"></a>

### Syntax Used In Grammar

<a id="text-syntax-used-in-grammar"></a>
...
<a id="outline-container-arg-grammar"></a>

<a id="arg-grammar"></a>

### Query Arg Grammar

<a id="text-arg-grammar"></a>
...
<a id="outline-container-rule-grammar"></a>

<a id="rule-grammar"></a>

### Query Rule Grammar

<a id="text-rule-grammar"></a>
...
<a id="outline-container-queries"></a>
...
- `qseq` [Peer API](../../../04-apis/01-peer-api-clojuredoc/peer-api-clojuredoc.md#datomic.api/qseq) \| [Client API](../../../04-apis/03-client-api-clojuredoc/client-api-clojuredoc.md#var-qseq)

<a id="outline-container-query-example"></a>

<a id="query-example"></a>

### Query Example

<a id="text-query-example"></a>
...
<a id="outline-container-find-specs"></a>

<a id="find-specs"></a>

## Find Specs

<a id="text-find-specs"></a>
...
<a id="outline-container-variables"></a>

<a id="variables"></a>

## Variables

<a id="text-variables"></a>
...
<a id="outline-container-find-variables-example"></a>

<a id="find-variables-example"></a>

### Find Variables Example

<a id="text-find-variables-example"></a>
...
<a id="outline-container-pull-expressions"></a>

<a id="pull-expressions"></a>

## Pull Expressions

<a id="text-pull-expressions"></a>
...
<a id="outline-container-pull-expressions-example"></a>

<a id="pull-expressions-example"></a>

### Finding Pull Expression Example

<a id="text-pull-expressions-example"></a>
...
<a id="outline-container-separation-of-concerns"></a>

<a id="separation-of-concerns"></a>

### Separation of Concerns

<a id="text-separation-of-concerns"></a>
...
<a id="outline-container-deploying"></a>

<a id="deploying"></a>

## Custom Query Functions

<a id="text-deploying"></a>

You can write your own custom functions for use as [aggregate](#aggregates), [predicate](#predicates), or [function](#functions) clauses in query. To make these functions available in Datomic Pro, follow the instructions to [deploy transaction functions](../../02-transactions/04-transaction-functions/transaction-functions.md#deploying). To make these functions available in Datomic Cloud, follow the instructions to deploy as an [ion](../../../07-datomic-cloud-ions/02-ions-reference/ions-reference.md#ion-config).

You can [cancel](../../02-transactions/04-transaction-functions/transaction-functions.md#canceling) custom query functions.

<a id="outline-container-return-maps"></a>

<a id="return-maps"></a>

## Return Maps

<a id="text-return-maps"></a>
...
<a id="outline-container-aggregates"></a>

<a id="aggregates"></a>

## Aggregates

<a id="text-aggregates"></a>
...
<a id="outline-container-aggregate-example"></a>

<a id="aggregate-example"></a>

### Example Aggregate

<a id="text-aggregate-example"></a>
...
<a id="outline-container-built-in-aggregates"></a>

<a id="built-in-aggregates"></a>

### Built-In Aggregates

<a id="text-built-in-aggregates"></a>
...
<a id="outline-container-aggregates-returning-a-single-value"></a>

<a id="aggregates-returning-a-single-value"></a>

### Aggregates Returning a Single Value

<a id="text-aggregates-returning-a-single-value"></a>

The aggregation functions that return a single value are listed below, and all behave as their names suggest.

- *min* and *max*  
  <a id="text-min-and-max"></a>
...
- *count* and *count-distinct*  
  <a id="text-count-and-count-distinct"></a>
...
<a id="outline-container-aggregates-returning-collections"></a>

<a id="aggregates-returning-collections"></a>

### Aggregates Returning Collections

<a id="text-aggregates-returning-collections"></a>

Where *n* is specified, fewer than *n* items may be returned if not enough items are available.

- *distinct*  
  <a id="text-distinct"></a>
...
- *min n* and *max n*  
  ...
  ```
- *rand n and sample n*  
  <a id="text-rand-n-and-sample-n"></a>
...
<a id="outline-container-inputs"></a>
...
<a id="outline-container-default-inputs"></a>

<a id="default-inputs"></a>

### Default Inputs

<a id="text-default-inputs"></a>
...
<a id="outline-container-inputs-example"></a>

<a id="inputs-example"></a>

### Inputs Example

<a id="text-inputs-example"></a>
...
<a id="outline-container-pattern-inputs"></a>

<a id="pattern-inputs"></a>

### Pattern Inputs

<a id="text-pattern-inputs"></a>
...
<a id="outline-container-binding-forms"></a>

<a id="binding-forms"></a>

## Binding Forms

<a id="text-binding-forms"></a>
...
<a id="outline-container-tuple-binding"></a>

<a id="tuple-binding"></a>

### Tuple Binding

<a id="text-tuple-binding"></a>
...
<a id="outline-container-collection-binding"></a>

<a id="collection-binding"></a>

### Collection Binding

<a id="text-collection-binding"></a>
...
<a id="outline-container-relation-binding"></a>

<a id="relation-binding"></a>

### Relation Binding

<a id="text-relation-binding"></a>
...
<a id="outline-container-where-clauses"></a>

<a id="where-clauses"></a>

## Where Clauses

<a id="text-where-clauses"></a>
...
<a id="outline-container-implicit-joins"></a>

<a id="implicit-joins"></a>

## Implicit Joins

<a id="text-implicit-joins"></a>
...
<a id="outline-container-data-patterns"></a>

<a id="data-patterns"></a>

## Data Patterns

<a id="text-data-patterns"></a>
...
<a id="outline-container-blanks"></a>
...
<a id="outline-container-implicit-blanks"></a>

<a id="implicit-blanks"></a>

### Implicit Blanks

<a id="text-implicit-blanks"></a>
...
<a id="outline-container-predicates"></a>
...
<a id="outline-container-predicate-example"></a>

<a id="predicate-example"></a>

### Predicate Example

<a id="text-predicate-example"></a>
...
<a id="outline-container-range-predicates"></a>

<a id="range-predicates"></a>

### Range Predicates

<a id="text-range-predicates"></a>
...
<a id="outline-container-functions"></a>
...
<a id="outline-container-function-example"></a>

<a id="function-example"></a>

### Function Example

<a id="text-function-example"></a>
...
<a id="outline-container-built-in-functions"></a>

<a id="built-in-functions"></a>

## Built-in Predicates and Functions

<a id="text-built-in-functions"></a>
...
- A set of functions that are aware of Datomic's Log:
  - [tx-ids](../../../04-apis/09-log-api/log-api.md#log-in-query) \[Peer API\]
  - [tx-data](../../../04-apis/09-log-api/log-api.md#log-in-query) \[Peer API\]
...
<a id="outline-container-fulltext"></a>

<a id="fulltext"></a>

### fulltext

<a id="text-fulltext"></a>
...
<a id="outline-container-get-else"></a>

<a id="get-else"></a>

### *get-else*

<a id="text-get-else"></a>
...
<a id="outline-container-get-some"></a>

<a id="get-some"></a>

### *get-some*

<a id="text-get-some"></a>
...
<a id="outline-container-ground"></a>
...
<a id="outline-container-missing"></a>
...
<a id="outline-container-untuple"></a>
...
<a id="outline-container-calling-java-methods"></a>

<a id="calling-java-methods"></a>

## Calling Java Methods

<a id="text-calling-java-methods"></a>
...
<a id="outline-container-calling-static-methods"></a>

<a id="calling-static-methods"></a>

### Calling Static Methods

<a id="text-calling-static-methods"></a>
...
<a id="outline-container-calling-instance-methods"></a>

<a id="calling-instance-methods"></a>

### Calling Instance Methods

<a id="text-calling-instance-methods"></a>
...
<a id="outline-container-calling-clojure-functions"></a>

<a id="calling-clojure-functions"></a>

## Calling Clojure Functions

<a id="text-calling-clojure-functions"></a>
...
<a id="outline-container-not-clauses"></a>

<a id="not-clauses"></a>

## Not Clauses

<a id="text-not-clauses"></a>
...
<a id="outline-container-not-example"></a>

<a id="not-example"></a>

### Not Example

<a id="text-not-example"></a>
...
<a id="outline-container-how-not-clauses-work"></a>

<a id="how-not-clauses-work"></a>

### How Not Clauses Work

<a id="text-how-not-clauses-work"></a>
...
<a id="outline-container-insufficient-binding-for-a-not-clause"></a>

<a id="insufficient-binding-for-a-not-clause"></a>

### Insufficient Binding for a Not Clause

<a id="text-insufficient-binding-for-a-not-clause"></a>

All variables used in a *not* clause will unify with the surrounding query. This includes both the arguments to nested expression clauses as well as any bindings made by nested function expressions. Datomic will attempt to push the *not* clause down until all necessary variables are bound, and will throw an `::anom/incorrect` [anomaly](../../../04-apis/14-error-handling/error-handling.md) if that is not possible.
...
<a id="outline-container-not-join"></a>

<a id="not-join"></a>

## Not-join Clauses

<a id="text-not-join"></a>
...
<a id="outline-container-not-join-example"></a>

<a id="not-join-example"></a>

### Not-join Example

<a id="text-not-join-example"></a>
...
<a id="outline-container-multiple-clauses-in-not-or-not-join"></a>

<a id="multiple-clauses-in-not-or-not-join"></a>

### Multiple Clauses In not Or not-join

<a id="text-multiple-clauses-in-not-or-not-join"></a>
...
<a id="outline-container-or-clauses"></a>

<a id="or-clauses"></a>

## Or Clauses

<a id="text-or-clauses"></a>
...
<a id="outline-container-or-example"></a>

<a id="or-example"></a>

### Or Clause Example

<a id="text-or-example"></a>
...
<a id="outline-container-or-clause-variables"></a>

<a id="or-clause-variables"></a>

### Or Clause Variables

<a id="text-or-clause-variables"></a>
...
<a id="outline-container-how-or-clauses-work"></a>

<a id="how-or-clauses-work"></a>

### How Or Clauses Work

<a id="text-how-or-clauses-work"></a>
...
<a id="outline-container-and-clause"></a>

<a id="and-clause"></a>

## And Clause

<a id="text-and-clause"></a>
...
<a id="outline-container-and-example"></a>

<a id="and-example"></a>

### And Clause Example

<a id="text-and-example"></a>
...
<a id="outline-container-or-join"></a>
...
<a id="outline-container-or-join-example"></a>

<a id="or-join-example"></a>

### Or-join Example

<a id="text-or-join-example"></a>
...
<a id="outline-container-with-example"></a>

<a id="with-example"></a>

### Example with-clause

<a id="text-with-example"></a>
...
<a id="outline-container-rules"></a>
...
<a id="outline-container-defining-rule"></a>

<a id="defining-rule"></a>

### Defining a Rule

<a id="text-defining-rule"></a>
...
<a id="outline-container-using-rule"></a>

<a id="using-rule"></a>

### Using a Rule

<a id="text-using-rule"></a>
...
<a id="outline-container-multiple-rule-heads"></a>

<a id="multiple-rule-heads"></a>

### Multiple Rule Heads

<a id="text-multiple-rule-heads"></a>
...
<a id="outline-container-rule-required-bindings"></a>

<a id="rule-required-bindings"></a>

### Required Bindings

<a id="text-rule-required-bindings"></a>
...
But sometimes you know that a rule will only be correct, or only be efficient, if some variables are already bound. You can require that some variables be bound before a rule can fire by enclosing the required variables in a vector or list as the first argument to the rule. If the required variables are not bound, Datomic will report an incorrect [anomaly](../../../04-apis/04-client-api/additional-client-api-reference/additional-client-api-reference.md#anomalies).
...
<a id="outline-container-rule-database-scoping"></a>

<a id="rule-database-scoping"></a>

### Rule Database Scoping

<a id="text-rule-database-scoping"></a>
...
<a id="outline-container-rule-generality"></a>

<a id="rule-generality"></a>

### Rule Generality

<a id="text-rule-generality"></a>
