...
1.  One of our earliest tests of Datomic was an import of the full mbrainz dataset. This import adds about 100 million (10^8) datoms. A vanilla developer laptop has plenty of CPU and I/O to import this dataset, using Datomic Pro’s default settings.
...
<a id="outline-container-sublinear"></a>

<a id="sublinear"></a>

## When Sublinear Isn't

<a id="text-sublinear"></a>
