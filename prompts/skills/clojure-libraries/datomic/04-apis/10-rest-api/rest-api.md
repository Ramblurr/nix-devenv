...
The URIs are as described in the [documentation for connect](../02-peer-api-javadoc/classes/peer/peer.md) with the database name elided, for example:
...
<a id="outline-container-accessing"></a>

<a id="accessing"></a>

## Accessing the Service

<a id="text-accessing"></a>
...
<a id="outline-container-api-operations"></a>

<a id="api-operations"></a>

## API Operations

<a id="text-api-operations"></a>

This section lists the API operations exposed by the service, including the required URL format and parameters.

<a id="outline-container-list-aliases"></a>

<a id="list-aliases"></a>

### List Aliases

<a id="text-list-aliases"></a>
...
<a id="outline-container-list-databases"></a>

<a id="list-databases"></a>

### List Databases

<a id="text-list-databases"></a>
...
<a id="outline-container-transact"></a>

<a id="transact"></a>

### Transact

<a id="text-transact"></a>
...
<a id="outline-container-retrieve-database-info"></a>

<a id="retrieve-database-info"></a>

### Retrieve Database Info

<a id="text-retrieve-database-info"></a>
...
<a id="outline-container-subscribe-to-events"></a>

<a id="subscribe-to-events"></a>

### Subscribe to Events

<a id="text-subscribe-to-events"></a>
