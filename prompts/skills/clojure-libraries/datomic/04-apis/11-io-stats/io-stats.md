...
<a id="outline-container-transaction-logging"></a>

<a id="transaction-logging"></a>

## Transaction Logging

<a id="text-transaction-logging"></a>
...
Note that transaction logging correlates io-stats with transaction t. Given t, you can use the [log API](../09-log-api/log-api.md) to query the datoms produced by the transaction.
...
<a id="outline-container-nested-io-stats"></a>

<a id="nested-io-stats"></a>

## Nested Io-Stats

<a id="text-nested-io-stats"></a>
...
<a id="outline-container-io-stats-reads-map"></a>

<a id="io-stats-reads-map"></a>

### Io-Stats :reads Map

<a id="text-io-stats-reads-map"></a>
...
| (storage of record) :ddb/:sql/:cass etc. | Count of segments accessed through Datomic storage (keys match the [storage protocol](../../05-operation/01-pro/01-storage-services/storage-services.md#storage-services) in use) |
...
<a id="outline-container-interpreting"></a>

<a id="interpreting"></a>

## Interpreting Io-Stats

<a id="text-interpreting"></a>
...
<a id="outline-container-io-stats-depend-on-the-current-state-of-the-caches"></a>

<a id="io-stats-depend-on-the-current-state-of-the-caches"></a>

### Io-Stats Depend on the Current State of the Caches

<a id="text-io-stats-depend-on-the-current-state-of-the-caches"></a>
...
<a id="outline-container-io-stats-depend-on-the-current-state-of-the-indexes"></a>

<a id="io-stats-depend-on-the-current-state-of-the-indexes"></a>

### Io-Stats Depend on the Current State of the Indexes

<a id="text-io-stats-depend-on-the-current-state-of-the-indexes"></a>
...
<a id="outline-container-relating"></a>

<a id="relating"></a>

## Relating Io-Stats to Transaction Time

<a id="text-relating"></a>
