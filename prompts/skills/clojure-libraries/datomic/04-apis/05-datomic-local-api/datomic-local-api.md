...
<a id="datomic-local-api"></a>

# Datomic Local API

<a id="outline-container-datomic-local-api"></a>

<a id="datomic-local-api"></a>

## Datomic Local API

<a id="text-datomic-local-api"></a>
...
- [release-db](#release-db) to release [memory used by a database](datomic-local-api.md)
...
<a id="outline-container-divert-system"></a>

<a id="divert-system"></a>

### divert-system

<a id="text-divert-system"></a>

Diverts subsequent [d/client](../03-client-api-clojuredoc/client-api-clojuredoc.md) calls for system to local storage. arg-map has the following keys:
...
<a id="outline-container-release-db"></a>

<a id="release-db"></a>

### release-db

<a id="text-release-db"></a>
...
<a id="outline-container-import-cloud"></a>

<a id="import-cloud"></a>

### import-cloud

<a id="text-import-cloud"></a>
