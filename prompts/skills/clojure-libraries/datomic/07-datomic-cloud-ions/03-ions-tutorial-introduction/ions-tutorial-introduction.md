...
- Data-driven applications that [are invoked](../07-entry-points/entry-points.md#invoke-lambda) via AWS lambda
...
- [AWS lambda](../07-entry-points/entry-points.md#invoke-lambda)
- [Datomic attribute and entity predicates, query functions, and transaction functions](../07-entry-points/entry-points.md#attribute-predicate)
...
<a id="outline-container-tutorial-prerequisites"></a>

<a id="tutorial-prerequisites"></a>

## Tutorial Prerequisites

<a id="text-tutorial-prerequisites"></a>

Before this tutorial, perform the following:

- Install Datomic Cloud Version 884-9095 or later. Follow the instructions to [create](../../05-operation/02-cloud/02-start-a-system/start-a-system.md) a new Datomic Cloud system, or to [upgrade](../../05-operation/02-cloud/14-upgrading/upgrading.md) an existing system
...
- Read the [ions](../01-ions-overview/ions-overview.md) overview
