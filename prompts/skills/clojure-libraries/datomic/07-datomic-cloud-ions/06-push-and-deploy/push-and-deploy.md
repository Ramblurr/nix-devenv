...
<a id="outline-container-configure-entry-points"></a>

<a id="configure-entry-points"></a>

### Configure Entry Points

<a id="text-configure-entry-points"></a>
...
<a id="outline-container-commit"></a>
...
<a id="outline-container-invoke-push"></a>

<a id="invoke-push"></a>

### Push a Revision

<a id="text-invoke-push"></a>
...
The [deploy](../01-ions-overview/ions-overview.md#how-deploy) operation installs your [pushed](#push) application on a Datomic compute group which you specify.
...
<a id="outline-container-monitor"></a>
...
The format to monitor [deploy-status](../02-ions-reference/ions-reference.md#deploy-status):
...
If your *deploy-status* doesn't reach `SUCCEEDED`, then use the [deploy-status troubleshooting guide](../../05-operation/02-cloud/13-cloud-troubleshooting/cloud-troubleshooting.md#troubleshooting-ion-deploy-status) to diagnose and fix and problems.
