...
<a id="read-revisited-more-query"></a>
...
<a id="outline-container-parameterized-query"></a>

<a id="parameterized-query"></a>

## Parameterized Query

<a id="text-parameterized-query"></a>
...
So far we have created and accumulated data. Now let's look at what happens when things [change over time](../06-retract/retract.md).
