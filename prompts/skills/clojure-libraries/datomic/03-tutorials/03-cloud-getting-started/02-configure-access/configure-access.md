...
<a id="outline-container-authorize-user"></a>

<a id="authorize-user"></a>

## Authorize Datomic Users

<a id="text-authorize-user"></a>
...
After this step, any IAM user or role in the Group [get connected](../03-get-connected/get-connected.md) and use Datomic.
